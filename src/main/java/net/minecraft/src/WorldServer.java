...
public class WorldServer extends World
{
    ...
    public boolean canMineBlock(EntityPlayer par1EntityPlayer, int par2, int par3, int par4)
    {
        ...
        if (!ForgeHooks.canMine(par1EntityPlayer, par2, par3, par4)){return false;} 
        if (this.mcServer.configManager.isOp(par1EntityPlayer.username))
        {
        	return true;
        }
        else if (var6 < mcServer.spawnProtectionSize)
        {
        	return false;
        }
        else
